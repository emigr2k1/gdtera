...
mod tests {
    ...
    fn line_selection() {
        ...
        selection = selection
            .rotate(num_lines, num_cols, &(Line(0)..Line(num_lines)), 7)
            .unwrap();
    ...
    fn rotate_in_region_up() {
        ...
        selection.update(Point::new(5, Column(1)), Side::Right);
        selection = selection
            .rotate(num_lines, num_cols, &(Line(1)..Line(num_lines - 1)), 4)
            .unwrap();
    ...
    fn rotate_in_region_down() {
        ...
        selection = selection
            .rotate(num_lines, num_cols, &(Line(1)..Line(num_lines - 1)), -5)
            .unwrap();
